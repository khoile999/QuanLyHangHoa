...
<div>
    <form name="updatedongia" method="post" action='./element_LHK/mdongia/dongiaAct.php?reqact=updatedongia' enctype="multipart/form-data">
        ...
        <table>
            ...
            <tr>
                <td>Ngày áp dụng:</td>
                <td><input type="date" name="ngayApDung"  name="ngayApDung" value="<?php echo $getLhUpdate->ngayApDung; ?>" /></td>
            </tr>
            <tr>
                <td>Ngày Kết Thúc:</td>
                <td><input type="date" name="ngayKetThuc"  name="ngayKetThuc" value="<?php echo $getLhUpdate->ngayKetThuc; ?>" /></td>
            </tr>
            <tr>
                <td>Điều kiện:</td>
